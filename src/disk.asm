...
file_detect_memory:
    ...
    dec a : jr z, .force_profi       ; 4 = Profi 1024 (#DFFD page groups)
    dec a : jr z, .force_ts          ; 5 = TS-Conf (Page3 #13AF)
    dec a : jr z, .force256          ; 6 = Pent 256: mode 0 already; D6 banks 8..15
